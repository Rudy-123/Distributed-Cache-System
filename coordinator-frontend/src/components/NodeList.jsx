  ...
  return (
    <>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
        {Object.entries(shards).map(([shardId, shardNodes]) => (
          <div key={shardId}>
            <h3 style={{ margin: "0 0 12px 0", color: "var(--text-secondary)", fontSize: "12px", textTransform: "uppercase", letterSpacing: "1px", borderBottom: "1px solid var(--border-muted)", paddingBottom: "8px", display: "inline-block" }}>
              ⬡ {shardId}
            </h3>
            <div
              style={{
